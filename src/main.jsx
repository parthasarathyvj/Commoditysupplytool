...
function FreightManagement({ timeframe, onTimeframeChange }) {
  const [records, setRecords] = useState([
    { plant: 'BELOIT PLANT', growingArea: 'North Valley', period: '2024-2025', week: 'W1', planValue: '1,240', actualValue: '1,180' },
    { plant: 'CASA GRANDE PLANT', growingArea: 'Prairie South', period: '2025-2026', week: 'W2', planValue: '980', actualValue: '1,025' },
    { plant: 'CAMBRIDGE PLANT', growingArea: 'Maple Ridge', period: '2023-2024', week: 'W3', planValue: '760', actualValue: '720' },
  ])
