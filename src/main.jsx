...
function FreightManagement() {
  const [records, setRecords] = useState([
    ['BELOIT PLANT', 'North Valley', '1,240', '1,180'],
    ['CASA GRANDE PLANT', 'Prairie South', '980', '1,025'],
    ['CAMBRIDGE PLANT', 'Maple Ridge', '760', '720'],
  ])
